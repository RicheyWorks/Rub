...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name = "Rub"
                description = "The observability engine: tail-driven counters and point-in-time vitals over any SmokeHouse, the watcher promoted to an organ."
                url = "https://github.com/RicheyWorks/Rub"
                licenses {
                    license {
                        name = "MIT License"
                ...
                scm {
                    url = "https://github.com/RicheyWorks/Rub"
                    connection = "scm:git:https://github.com/RicheyWorks/Rub.git"
                }
            }
        }
    }
